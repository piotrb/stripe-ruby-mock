  ...
  module RequestHandlers
    module Subscriptions
      ...
      def create_subscription(route, method_url, params, headers)
        ...
        allowed_params = %w(customer application_fee_percent coupon items metadata plan quantity source tax_percent trial_end trial_period_days current_period_start created prorate billing days_until_due)
      ...
      def verify_card_present(customer, plan, subscription, params={})
        if customer[:default_source].nil? && customer[:trial_end].nil? &&
          ...
          customer[:billing] == 'charge_automatically'
